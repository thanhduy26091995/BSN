package com.hbbmobile.bsnapp.push_notification;
...
public class PushMessage {
    ...
    public static void sendMessage(final JSONArray recipients, final String title, final String body, final String icon, final String message) {
